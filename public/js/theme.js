var themeConfig = {
    dark: {
        ...
        keshihuaTableTdNotFinishedColor: "#b1c8fe",
    ...
    black: {
        ...
        mainBgColor: "#030303",
        mainBgLinearGradient: "url(../images/black/mainBg.png)",
        keshihuaTableTbodyTdColor: "#b7e2ff",
        keshihuaTableTbodyTrEvenBg: "#0b1b2a",
        keshihuaTableTbodyTrOddBg: "#0a1621",
        keshihuaTableTheadTrImage: "linear-gradient(0deg, #092233, #092233)",
        keshihuaTableBorderColor: "#1f4c64",
        keshihuaTableHandleLook: "#00c0ff",
        keshihuaTableHandleDel: "#00c0ff",
        keshihuaTableTdFinishedColor: "#ffffff",
        keshihuaTableTdNotFinishedColor: "#00a8ff",
        keshihuatableChecked: 'url(../images/black/black-icon-all.png)',
