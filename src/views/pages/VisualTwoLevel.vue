    ...
    <div class="wrapbody">
        <section id="main">
            ...
            <div class="echart-box clearfix">
                <div class="echart-item fl" v-for="(item,index) in  StaticList" :key="index">
                    <span class="title"><i></i>{{item.name}}</span>
                    <div class="echart-content" @click="dialogSetOption(item.name)">
                        <swiper-chart class="echart" :values="item.echartsBarOption"></swiper-chart>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div id="alert-box-tezhenggongcheng1" >
                ...
                <div class="content-wrap">
                    ...
                    <div class="btn-wrap text-c">
                        <button class="btn begin" style="margin:0px" @click="toView">进行可视化</button>
                    </div>
                </div>
            </div>
        </div>
